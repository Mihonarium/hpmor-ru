  ...
  return (
    <Layout
      ...
      <main>
		  ...
		  <p>Книга «Гарри Поттер и методы рационального мышления» на русском языке свободно доступна на этом сайте. Выберите подходящий формат: 
	      <ul class="pl0-ns ml0">
...
<li class="list f5 w-100 underline-hover nl1">
Читать онлайн на этом сайте: начните с <a href="/book/">предисловия</a> или <a href="/book/1/1/">первой главы</a>. На сайте доступен тёмный режим.
</li></ul></p>

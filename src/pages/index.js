      ...
      <main>
          <section className={styles.features}>
            <div className="container">
			  ...
			  <p>Чтобы скачать книгу, выберите подходящий формат в меню сайта. Или читайте прямо тут, начните с <a href="/book/">предисловия</a> или <a href="/book/1/1/">первой главы</a>. Доступен тёмный режим.</p>
<p>Можно <a href="https://reglet.ru/pechat/hpmor/">заказать печать</a> бумажных экземпляров книги.</p>

...
<p>Библиотеки могут получить бесплатные бумажные экземпляры, заполнив <a href="/l">эту форму для библиотек</a>. Победители некоторых олимпиад могут получить бесплатные экземпляры, заполнив <a href="/getbooks/?olymp">эту форму для олимпиадников</a>.</p>

...
<p>Библиотеки могут получить бесплатные бумажные экземпляры, заполнив <a href="/l">форму для библиотек</a>. Победители некоторых олимпиад могут получить бесплатные экземпляры, заполнив <a href="/getbooks/?olymp">форму для олимпиадников</a>.</p>
